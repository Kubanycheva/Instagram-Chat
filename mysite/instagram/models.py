...
class Post(models.Model):
    ...
    video = models.FileField(upload_to='post_vide', null=True, blank=True)
...
class Story(models.Model):
    ...
    image = models.ImageField(upload_to='image_story', null=True, blank=True)
    video = models.FileField(upload_to='video_story', null=True, blank=True)
    created_at = models.DateField(auto_now=True)
...
class SaveItem(models.Model):
    ...
    saved = models.ForeignKey(Saved, on_delete=models.CASCADE, related_name='save_saveItem', null=True, blank=True)
